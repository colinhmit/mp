...
example = unicode("Apple's stocks dropped dramatically after the death of Steve Jobs in October.")
parsedEx = parser(example)
...
messyData = unicode("lol that is rly funny :) This is gr8 i rate it 8/8!!!")
